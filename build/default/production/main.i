...
CONFIG_TMR0:
    ...
    BSF ((OPTION_REG) and 07Fh), 0 ; PS<2:0> -> 111 prescaler 1 : 64
...
CONFIG_TMR1:
    ...
    BCF ((T1CON) and 07Fh), 5 ; Prescaler 1:2
...
CONFIG_INT:
    ...
    BSF ((INTCON) and 07Fh), 7 ; Habilitamos int. globales
